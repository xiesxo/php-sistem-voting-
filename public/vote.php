...
<head>
  ...
  <style>
    ...
    /* ===== Tombol Voting ===== */
    .btn-vote {
      background-color: #6a0dad; /* Warna ungu utama */
      color: white;
      border: none;
      border-radius: 50px;
      font-weight: 600;
      ...
      .btn-vote:hover {
      background-color: #8e44ec; /* Warna ungu lebih terang saat hover */
...
<!-- ===== Footer (Opsional, tambahkan jika perlu) ===== -->
<!-- <footer class="text-center py-4 bg-light mt-5">
  <small>&copy; <?= date('Y') ?> E-Vote. All rights reserved.</small>
</footer> -->
